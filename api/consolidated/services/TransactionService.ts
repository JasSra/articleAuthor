...
import type { TransactionOperationResult } from '../models/TransactionOperationResult';
...
export class TransactionService {
     ...
     * @throws ApiError
     */
    public static getApiTransactionAll(
        page: number = 1,
        size: number = 100,
    ...
    /**
     * @param id
     * @returns TransactionOperationResult OK
     * @throws ApiError
     */
    public static getApiTransaction(
        id: string,
    ): CancelablePromise<TransactionOperationResult> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static deleteApiTransaction(
        id: string,
     ...
     * @throws ApiError
     */
    public static getApiTransactionAudit(
        id: string,
        from?: string,
        to?: string,
        count: number = 1000,
     ...
     * @throws ApiError
     */
    public static getApiTransactionRaw(
        id: string,
    ): CancelablePromise<BaseCrmEntityOperationResult> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/Transaction/raw/{id}',
            path: {
                'id': id,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static putApiTransactionUpdate(
        id: string,
     ...
     * @throws ApiError
     */
    public static deleteApiTransactionRemoveAll(): CancelablePromise<BooleanListOperationResult> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/Transaction/remove/all',
            errors: {
                400: `Bad Request`,
                401: `Unauthorized`,
                403: `Forbidden`,
     ...
     * @throws ApiError
     */
    public static postApiTransactionCreate(
        requestBody?: Record<string, any>,
    ): CancelablePromise<BaseCrmEntityOperationResult> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static getApiTransactionDisplay(
        page: number = 1,
        size: number = 100,
    ): CancelablePromise<ReferenceLookupSearchResultOperationResult> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/Transaction/display',
            query: {
                'page': page,
                'size': size,
            },
     ...
     * @throws ApiError
     */
    public static getApiTransactionNextstates(
        id: string,
    ): CancelablePromise<StringStringListDictionaryOperationResult> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/Transaction/nextstates/{id}',
            path: {
                'id': id,
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static postApiTransactionMovetostateFieldNewstate(
        id: string,
        fieldId: string,
        newState: string,
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/Transaction/movetostate/{id}/field/{fieldId}/newstate/{newState}',
            path: {
                'id': id,
                'fieldId': fieldId,
                'newState': newState,
     ...
     * @throws ApiError
     */
    public static getApiTransactionSuggestionsField(
        fieldId: string,
        prefix?: string,
    ): CancelablePromise<Array<string>> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/Transaction/suggestions/field/{fieldId}',
            path: {
                'fieldId': fieldId,
            },
            query: {
